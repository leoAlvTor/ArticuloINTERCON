...
final_diagnosis_list = join_lists_as_set(unique_simple_values, unique_separated_values)

headers = api_CIE11.generate_headers()

for element in final_diagnosis_list:
    print(element, api_CIE11.search_diagnosis(api_CIE11.generate_body(element), headers).chapters)
